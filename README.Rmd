...
[![R build status](https://github.com/openvolley/auvolley/workflows/R-CMD-check/badge.svg)](https://github.com/openvolley/auvolley/actions)
<!-- badges: end -->
...
The `auvolley` package provides some simple functions for calculating scores following the Athletes Unlimited scoring system. See https://auprosports.com/volleyball/how-we-play-volleyball/ and [their whitepaper](https://auprosports.com/wp-content/uploads/2021/02/Athletes-Unlimited-Volleyball-Scoring-Sytstem-2.16.21.pdf) for more information.
